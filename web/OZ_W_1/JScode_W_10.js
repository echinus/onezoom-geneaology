...
var zoomoutnum;
	...
	function Resize_only()
	{
        ...
        document.getElementById("headerspace").width = widthres-630;
...
function autotext3(initalic,texttodisp,textx,texty,textw,defpt)
{
    ...
    function drawopen()
    {
        ...
        context.beginPath();
        context.lineWidth = 1;
        context.lineTo( myCanvas.width -372 , 40 );
        context.lineTo( myCanvas.width -372, 10);
        context.lineTo( myCanvas.width -180, 10 );
        context.lineTo( myCanvas.width -180, 40 );
        context.fillStyle = 'rgba(0,0,0,0.85)';
        context.fill();
        context.fillStyle = 'rgb(255,255,255)';
        autotext(false, "Click or scroll to zoom" , myCanvas.width -276, 25 , 250 , 14);
        //autotext2(false, "This message will disappear when you begin using OneZoom." , myCanvas.width -207, 130 , 280 , 25);
        context.beginPath();
        context.fillStyle = 'rgba(0,0,0,0.85)';
        context.lineTo( myCanvas.width -330 , 10 );
        context.lineTo( myCanvas.width -310, 10);
        context.lineTo( myCanvas.width -320, 0 );
        context.fill();
        context.beginPath();
        context.fillStyle = 'rgba(0,0,0,0.85)';
        context.lineTo( myCanvas.width -362 , 10 );
        context.lineTo( myCanvas.width -342, 10);
        context.lineTo( myCanvas.width -352, 0 );
        context.fill();
	...
	function draw2()
	{
        ...
        if (popuptext)
        {
            context.beginPath();
			context.lineWidth = 1;
			context.lineTo( myCanvas.width -364 , 40 );
			context.lineTo( myCanvas.width -364, 10);
			context.lineTo( myCanvas.width -21, 10 );
			context.lineTo( myCanvas.width -21, 40 );
			context.fillStyle = 'rgba(0,0,0,0.85)';
			context.fill();
        ...
        if (popuptext2)
        {
			...
			context.fill();
			context.fillStyle = 'rgb(255,255,255)';
			autotext(false, popuptext2 , 137, 25 , 250 , 14);
        }
